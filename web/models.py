...
class Note(BaseModel):
    ...
    note_group = models.ForeignKey('NoteGroup', on_delete=models.SET_NULL, verbose_name='属组', null=True)
    # 默认反向关联为 小写类名_set 可以自定义
    # note_group = models.ForeignKey('NoteGroup', on_delete=models.SET_NULL, verbose_name='属组', null=True, related_name='notes')
